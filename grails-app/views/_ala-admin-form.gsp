<div class="card mb-4">
    <div class="card-header">
        <h3 class="mb-0">Display System Message</h3>
    </div>
    <div class="card-body">
        <g:form controller="alaAdmin" action="systemMessage">
            ...
            <div class="mb-3">
                ...
                <g:select class="form-select" name="severity" from="${["info", "warning", "danger"]}" value="${sms.systemMessage?.severity}" />
            </div>

            <g:actionSubmit value="Set message" class="btn btn-primary" action="systemMessage"/>
            <g:actionSubmit value="Clear message" class="btn btn-outline-dark" action="clearMessage"/>
        </g:form>
    </div>
</div>
<hr/>
...
<div class="card mb-4">
    <div class="card-header">
        <h3 class="mb-0">Grails Config</h3>
    </div>
    <div class="card-body">
        <g:form controller="alaAdmin" action="reloadConfig">
            ...
            <a href="${request.contextPath}/alaAdmin/viewConfig" class="btn btn-outline-dark">View current config</a>
        </g:form>
    </div>
</div>
<hr/>
...
<div class="card mb-4">
    <div class="card-header">
        <h3 class="mb-0">Build information</h3>
    </div>
    <div class="card-body">
